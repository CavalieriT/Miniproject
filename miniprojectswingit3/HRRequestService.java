...
public class HRRequestService {
    ...
    public static HRRequest createHRRequest(int hrRequestID, String contractType, Department department, String yearOfExperience, String jobTitle, String jobDescription){
    ...
    public static boolean sendtoHR(String hrRequestID){
        HRRequest hrRequest = hrRequests_pm.get(hrRequestID);
        if(hrRequest != null){
