...
public class CSOInterfaceGUI {
    ...
    private static void createClientRequest() {
        ...
        RequestStatus status = RequestStatus.IN_PROGRESS; // The CSO doesn't have power to decide the status

        requestService.createRequest(recordNumber, clientID, eventType, eventFromDate, eventToDate, expectedAttendees, preferences, budget, status, UserRole.CUSTOMER_SERVICE);
